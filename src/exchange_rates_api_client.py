...
class ExchangeRatesApiClient(ExchangeRateProvider):
    async def provide(self, source_coin: Coin, target_coin: Coin) -> PositiveFloat:
        exchange_rate_api_url = self.__build_exchange_rate_api_url(source_coin, target_coin)
    ...
    def __build_exchange_rate_api_url(self, source_coin: Coin, target_coin: Coin) -> str:
        return f"https://api.exchangerate.host/convert?from={source_coin}&to={target_coin}"
